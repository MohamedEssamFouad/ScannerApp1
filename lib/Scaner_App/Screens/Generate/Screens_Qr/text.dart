...
class text_q extends StatefulWidget {
  @override
  State<text_q> createState() => _text_qState();
}

class _text_qState extends State<text_q> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create Text QR Code'),
      ),
      body: SafeArea(
        child: Padding(
              ...
              Stack(
                children: [
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          ...
                                          final qrCodeData=  QrCodeData(
                                              qrData: qrData,
                                              timestamp: DateTime.now(), processName: 'text', iconIdentifier: 'text',
                                            );
                  ...
                  Positioned(
                    ...
                    child: CircleAvatar(
                      radius: 30,
                      backgroundColor:     Color(0xFF81C16B),
