...
import '../../../SQFLITE&providers/HistoryPage.dart'; // Import the necessary class here
import 'qr_result_page.dart'; // Import your QrResultPage class here
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create Call QR Code'),
      ),
      body: SafeArea(
        child: Padding(
