...
class CodE93 extends StatefulWidget {
  @override
  State<CodE93> createState() => _CodE93State();
}

class _CodE93State extends State<CodE93> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create CODE 93  Barcode'),
      ),
      body: SafeArea(
        child: Padding(
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'CODE93', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.code93(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
