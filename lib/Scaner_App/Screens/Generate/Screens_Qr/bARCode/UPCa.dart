...
class UPCA extends StatefulWidget {
  @override
  State<UPCA> createState() => _UPCAState();
}

class _UPCAState extends State<UPCA> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create UPCA Barcode'),
      ),
      body: SafeArea(
        child: Padding(
                              ...
                              children: [
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: 'please type any 7 digits and ....',
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'UPCA', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.upcA(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
