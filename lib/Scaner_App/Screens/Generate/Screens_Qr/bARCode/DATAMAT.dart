...
class dataMat extends StatefulWidget {
  @override
  State<dataMat> createState() => _dataMatState();
}

class _dataMatState extends State<dataMat> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create CODABAR Barcode'),
      ),
      body: SafeArea(
        child: Padding(
                              ...
                              children: [
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: 'please type any digits and alphabet (ex.A12345678)',
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'DATA MATRIX', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.dataMatrix(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
