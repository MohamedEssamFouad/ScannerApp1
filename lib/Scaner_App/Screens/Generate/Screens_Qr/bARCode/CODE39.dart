...
class CodeE39 extends StatefulWidget {
  @override
  State<CodeE39> createState() => _CodeE39State();
}

class _CodeE39State extends State<CodeE39> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create CODE39 Barcode'),
      ),
      body: SafeArea(
        child: Padding(
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'CODE39', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.code39(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
