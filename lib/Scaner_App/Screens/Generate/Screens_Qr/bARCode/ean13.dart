...
class ean13 extends StatefulWidget {
  @override
  State<ean13> createState() => _ean13State();
}

class _ean13State extends State<ean13> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create EAN13 Barcode'),
      ),
      body: SafeArea(
        child: Padding(
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'EAN13', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.ean13(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
