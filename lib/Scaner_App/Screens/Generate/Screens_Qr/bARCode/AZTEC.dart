...
class AZTEC extends StatefulWidget {
  const AZTEC({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create AZTEC Barcode'),
      ),
      body: SafeArea(
        child: Padding(
                              ...
                              children: [
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: 'please type alphabets and digits',
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'AZTEC', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.aztec(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
