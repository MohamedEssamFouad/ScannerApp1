...
class ITF extends StatefulWidget {
  @override
  State<ITF> createState() => _ITFState();
}

class _ITFState extends State<ITF> {
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'ITF', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.itf(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
