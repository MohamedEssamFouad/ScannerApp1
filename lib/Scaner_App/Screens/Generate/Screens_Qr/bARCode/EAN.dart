...
class EAN extends StatefulWidget {
  @override
  State<EAN> createState() => _EANState();
}

class _EANState extends State<EAN> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create EAN8 Barcode'),
      ),
      body: SafeArea(
        child: Padding(
                              ...
                              children: [
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: 'please type any 8 digits',
                                        ...
                                        onTap: () {
                                          ...
                                          if (enteredText.isNotEmpty) {
                                            ...
                                            final qrCodeData = QrCodeData(
                                              qrData: BARCODE,
                                              timestamp: DateTime.now(), processName: 'EAN8', iconIdentifier: 'BARCODE',
                                            );
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    BarRES(Bar: BARCODE, format: Barcode.ean8(),),
                                              ),
                                            );
                                          } else {
                                            showDialog(
